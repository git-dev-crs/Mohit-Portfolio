                ...
                >
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center space-x-4">
                            ...
                            <a href="https://www.linkedin.com/in/mohit-jatav-6819a0260/" target="_blank" rel="noopener noreferrer" className="hover:underline">Linkedin</a>
                        </div>
                        <div className="flex items-center space-x-4">
                            <img src={github} alt="GitHub" className="h-8 w-8" />
                            <a href="https://github.com/git-dev-crs" target="_blank" rel="noopener noreferrer" className="hover:underline">Github</a>
                        </div>
                        <div className="flex items-center space-x-4">
                            <img src={icon} alt="Twitter" className="h-8 w-8" />
                            <a href="https://leetcode.com/u/MohitJ111/" target="_blank" rel="noopener noreferrer" className="hover:underline">Leetcode</a>
                        </div>
                        <div className="flex items-center space-x-4">
                            <img src={mail} alt="Mail" className="h-8 w-8" />
                            <a href="mailto:mohitjatav326@gmail.com" className="hover:underline">Mail [mohitjatav326@gmail.com]</a>
                        </div>
                        <div className="flex items-center space-x-4">
                            <img src={mobilephone} alt="Mail" className="h-8 w-8" />
                            <a href="tel:+917489417866" className="hover:underline">Call[+917489417866]</a>
                        </div>
                    </div>
                </motion.div>
            </div >
